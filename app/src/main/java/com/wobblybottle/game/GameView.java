...
public class GameView extends View {
    ...
    private static final String[][] PACK_TRUTHS_TR = {
        ...
        { // 4: +18 Ateşli
            ...
            "En gizli fantezin ne (ama burada itiraf edebileceğin)?",
            "İdeal öpücüğünü detaylı tarif et. Nerede? Nasıl? Hangi ortam?",
            "En tuhaf yerde öptüğün (ya da öpmek istediğin) yer neresi?",
            "Hiç tek gecelik ilişki yaşadın mı? Eğer evetse, iyi mi kötü mü geçti?",
            "Arzu için yapmaya hazır olduğun en çılgın ya da cesur şey ne?",
            "Uzun ve duyusal ön sevişme mi yoksa doğrudan konuya mı?",
            "Sana yapılan en seksi iltifat neydi?",
            "Hiç yaramaz mesaj ya da fotoğraf gönderdin mi? Kime?",
            "Hangi ünlü (erkek ya da kadın) seni en çok fanteziye sürüklüyor?",
            "Samimi bir anda başına gelen en utanç verici şey ne?",
            "Loş ışık mı yoksa tamamen karanlık mı? Neden?",
            "Bu odadakilerden birini erotik bir rüyada gördün mü?",
            "Hangi film ya da film sahnesi seni özellikle moduna sokuyor?",
            "Kesin kızarmana ne sebep olur?",
            "İç çamaşırı: Rahat mı, seksi mi yoksa ikisi mi?",
            "Seni anında heyecanlandıran 'küçük şey' ne (jest, kelime, koku...)?",
            "Hiç sadece cinsel ilişki yaşadın mı (friends with benefits)?",
            "Cinsel ilişki sırasında senin için en önemli şey ne?",
            "Hiç yakalandın mı? Anlat!",
            "Ağzın dışında vücudunda öpülmekten en hoşlandığın yer neresi?",
            "Partner sayın hakkında hiç yalan söyledin mi?",
            "Duyusal ortam için mükemmel müzik ne senin için? Bir şarkı adı ver!",
            "Mutlak 'turn-off'ın (heves kıran) ne?",
            "Libidonu şu an bir hayvanla tanımlasan, hangisi olurdu?",
            "Zevk vermek mi yoksa almak mı? Ya da denge mi şart?",
            "Kulağına fısıldanacak en seksi şey ne?",
            "Hiç orgazm taklidi yaptın mı? Neden?",
            "En sevdiğin masaj türü ne (duyusal, rahatlatıcı, enerjik...)?",
            "Klasik erojen bölgeler dışında, başkalarında çekici bulduğun vücut parçası ne?",
            "İlk öpücük ya da daha fazlası için hiç inisiyatif aldın mı?",
            "En sevdiğin pozisyon ne (uyumak için... ya da başka 😉)?",
            "Denemek istediğin en yaygın fantezi ne?",
            "Korunma ile ilgili utanç verici bir deneyimin oldu mu?",
            "Senin için ideal cinsel ilişki süresi ne (ön sevişme dahil)?",
            "Eylem sırasında 'kirli konuşma' (dirty talk) hakkında ne düşünüyorsun?",
            "Normal kriterlerine uymayan birine hiç çekildin mi?",
            "Hangi koku (parfüm, ten...) seni deli ediyor?",
            "Herhangi biriyle bir gece geçirsen, kimi seçerdin?",
            "Partnerine yapmaktan hoşlandığın en duyusal jest ne?",
            "Kamusal ya da yarı kamusal bir yerde cinsel deneyim yaşadın mı?",
            "Yatakta sana en çok güven veren ne?",
            "Kendi cinselliğin hakkında öğrendiğin en önemli şey ne?",
            "Aşk oyunlarında yiyecek kullandın mı (krema, çikolata...)?",
